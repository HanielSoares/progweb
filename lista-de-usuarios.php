        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="lista-de-usuarios" class="nav-link">Home</a> </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="lista-de-usuarios">Home</a></li>
    ...
    $qtd_prod = count($listaUsuario);
                        ...
                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            <td>".
                                            $listaUsuario[$i]["id"]."</td>
                                            <td>".$listaUsuario[$i]["nome"]."</td>
                                            <td><span class=\"badge text-bg-primary\">".$listaUsuario[$i]["email"]."</span></td>

                                            <td class=\"text-center\">
                                              <a href=\"edita-usuario.php?id=".$listaUsuario[$i]["id"]."\" class=\"btn btn-primary btn-sm\" title=\" Editar\">
                                              <i class=\"bi bi-pencil\"></i>
                                            </a> 
                                            <a href=\"exclui-usuario.php?id=".$listaUsuario[$i]["id"]."\" class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza que deseja excluir este usuario?');\">
