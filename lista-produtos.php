                        ...
                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                           ...
                                           <td>R$".number_format($listaProdutos[$i]["preco"], 2, ',', '.')."</td>
                                            ...
                                            <a href=\"exclui-produto.php?id=".$listaProdutos[$i]["id"]."\" class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza que deseja excluir este produto?');\">
