...
if($stmt->execute()){
   $msg = "Cliente atualizado com sucesso!"; 
    ...
    $msg = "Erro ao autalizar o Cliente.";
}
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="edita-clientes.php?id=<?php echo $clientes['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea 
                                         ...
                                         name="email" 
                                          class="form-control" 
                                         required><?php echo htmlspecialchars($clientes['email']); ?></textarea>
                                         <div class="invalid-feedback">
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-clientes.php?id=<?php echo htmlspecialchars($clientes['id']); ?>" 
