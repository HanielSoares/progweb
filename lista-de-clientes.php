        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="lista-de-clientes.php" class="nav-link">Home</a> </li>
    ...
    $qtd_prod = count($listaClientes);
                        ...
                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            ...
                                            <a href=\"exclui-clientes.php?id=".$listaClientes[$i]["id"]."\" class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza que deseja excluir este Cliente?');\">
