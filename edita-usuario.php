...
if($stmt->execute()){
   $msg = "Usuário atualizado com sucesso!"; 
    ...
    $msg = "Erro ao autalizar o Usuário.";
}
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title"> Edita PUsuario :: <?php echo $usuario["id"]."|" .$usuario["nome"];?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-usuario.php?id=<?php echo $usuario['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="invalid-feedback">
                                            Por favor, insira o nome do seu usuario.
                                        </div>
                                    </div>

                                    <!-- Campo Categoria -->
                                    <div class="mb-3">
                                        <label for="decricao" class="form-label">email</label>
                                        <textarea 
                                         id="email" 
                                         name="email" 
                                          class="form-control" 
                                         required><?php echo htmlspecialchars($usuario['email']); ?></textarea>
                                         <div class="invalid-feedback">
                                            Por favor, insira o nome um email.
                                        </div>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-produto.php?id=<?php echo htmlspecialchars($usuario['id']); ?>" 
