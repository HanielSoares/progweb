...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $sql ="UPDATE produtos SET nome = :nome, categoria = :categoria, marca = :marca, tamanho = :tamanho, cor = :cor, descricao = :descricao, preco = :preco WHERE id = :id";
...
if($stmt->execute()){
   $msg = "Produto atualizado com sucesso!"; 
    ...
    $msg = "Erro ao autalizar o produto.";
}
